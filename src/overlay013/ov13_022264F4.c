...
void StartBagTransitions(UnkStruct_ov13_022264F4 *param0)
{
...

    {
        ...
        for (v2 = 0; v2 < 5; v2++) {
            BagCursor_GetBattleCategoryPosition(v1, v2, &v0->unk_00->pocketCurrentPage[v2], &v0->unk_00->unk_2C[v2]);
        }
...
static u8 InitialiseTransitions(UnkStruct_ov13_02227244 *param0)
{
    ...
    if (param0->unk_00->unk_25 != 0) {
        SetBattlePartyBagCursorVisiblity(param0->unk_34, 1);
    }
...
static u8 DisplayBagMenu(UnkStruct_ov13_02227244 *param0)
{
...

    {
        ...
        if (v0 == TOUCHSCREEN_INPUT_NONE) {
            v0 = CheckBattleSubMenuCursorInputs(param0->unk_34);
...
{
    {
        ...
        case 5:
            if (GetBagItemOnPage(param0, v0) != ITEM_NONE) {
                Sound_PlayEffect(SEQ_SE_DP_DECIDE);
                param0->unk_00->pocketCurrentPage[param0->unk_114D] = (u8)v0;
                param0->unk_114B = 6;
...
static u8 ov13_02226948(UnkStruct_ov13_02227244 *param0)
{
    ...
    param0->unk_00->pocketCurrentPage[param0->unk_114D] = 0;
    v0 += param0->unk_114E;
...
{
    {
        ...
        case 0:
            Sound_PlayEffect(SEQ_SE_DP_DECIDE);
            param0->unk_00->unk_1C = GetBagItemOnPage(param0, param0->unk_00->pocketCurrentPage[param0->unk_114D]);
...
static u8 CleanupScreen(SysTask *param0, UnkStruct_ov13_02227244 *param1)
{
    ...
    if (param1->unk_00->unk_1C != 0) {
        ...
        for (v1 = 0; v1 < 5; v1++) {
            BagCursor_SetBattleCategoryPosition(v0, v1, param1->unk_00->pocketCurrentPage[v1], param1->unk_00->unk_2C[v1]);
        }
