...
static u8 CheckCanDoubleBattle(BattlePartyTask *param0);
...
void ov13_02225710(BattlePartyTask *param0, u16 *param1)
{
...
void ov13_02225A3C(BattlePartyTask *param0, u16 *param1)
{
...
static u16 *ov13_02225B40(BattlePartyTask *param0, u8 param1, u8 param2, u8 param3)
{
    switch (param1) {
    case 0:
    case 1:
...
static void ov13_02225C4C(BattlePartyTask *param0, u16 *param1, u8 param2, u8 param3, u8 param4)
{
    u16 *v0;
    u8 v1, v2;
    u8 v3, v4;
...
static void ov13_02225D8C(BattlePartyTask *param0, u8 param1, u8 param2, u8 param3)
{
    u16 *v0 = Heap_AllocFromHeap(param0->battleInfo->heapID, Unk_ov13_02229924[param1].unk_02 * Unk_ov13_02229924[param1].unk_03 * 2);
...
static void ov13_02225E08(BattlePartyTask *param0, u8 param1, u8 param2)
{
    const u8 *v0;
    u16 v1;
    u8 v2, v3;
...
static void ov13_02225EB8(BattlePartyTask *param0, u8 param1, u8 param2)
{
    switch (param1) {
    case 0:
    case 1:
    ...
    case 5:
        ...
        break;
    case 7:
        ManagedSprite_OffsetPositionXY(param0->unk_1FB4[0 + param0->battleInfo->selectedPartySlot], 0, Unk_ov13_02229890[param2]);
        ManagedSprite_OffsetPositionXY(param0->unk_1FB4[7 + param0->battleInfo->selectedPartySlot], 0, Unk_ov13_02229890[param2]);
        break;
    case 14:
    case 15:
    case 16:
...
void ov13_02225FCC(BattlePartyTask *param0, u8 param1)
{
    param0->unk_1F9F_4 = 0;
...
void ov13_0222601C(BattlePartyTask *param0)
{
...
void ov13_022260EC(BattlePartyTask *param0, u8 param1)
{
    u16 v0, v1;
    ...
    case IN_BATTLE_SCREEN_INDEX_MOVE_SUMMARY:
        ...
        for (v0 = 0; v0 < 4; v0++) {
            if (param0->battleInfo->unk_34 == v0) {
    ...
    case IN_BATTLE_SCREEN_LEARN_MOVE_2:
        ...
        if (param0->visitedContestHall == 1) {
...
void ov13_02226444(BattlePartyTask *param0, u8 param1)
{
...
void ov13_022264C4(BattlePartyTask *param0)
{
    if (ov13_022213F0(param0, param0->battleInfo->selectedPartySlot) == 2) {
        ov13_02225D8C(param0, 0 + param0->battleInfo->selectedPartySlot, 0, 1);
    } else {
        ov13_02225D8C(param0, 0 + param0->battleInfo->selectedPartySlot, 0, 0);
    }
}
