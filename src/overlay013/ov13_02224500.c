...
static void ov13_0222554C(UnkStruct_ov13_022213F0 *param0)
{
    ...
    SetInBattleCursorSprites(param0->unk_2084, v1);
}

static void ov13_022255B8(UnkStruct_ov13_022213F0 *param0)
{
    ov16_0226DCA8(GetInBattleCursorSprites(param0->unk_2084));
...
{
    SetIsInBattleCursorEnabled(param0->unk_2084, FALSE);
    ov13_02228A90(param0->unk_2084);
    ov16_0226DDE8(GetInBattleCursorSprites(param0->unk_2084));
}
